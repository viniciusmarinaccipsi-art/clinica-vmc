...
| 7 | 16.5d-2 — etapas: lista de subgrupos, barra deslizante, cabeçalho cumulativo, rodapé | `Leia docs/prompts/16.5/PROMPT_16_5d2.md e execute do início ao fim.` | 16.5c fechado (testado pelo usuário em 26/09) |
| 8–9 | 16.5e, 16.5f | prompts escritos pelo chat depois do "ok" do 16.5d-2 | 16.5d-2 |
