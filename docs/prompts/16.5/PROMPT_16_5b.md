...
## Passos
1. **Gabarito antes** (script do 16.5a; guardar). Observação herdada do 16.4.5: como a fonte e os pesos já foram aplicados, o item 4 do script agora mostra só os tokens NOVO como pendentes (os "MUDOU" viraram iguais); isso é o esperado, não é erro. Ao fim deste pacote, o item 4 deve ficar sem NOVO pendente.
